...
<img src='parstagramUpdate.gif' title='Parstagram Updated Walkthrough' width='250' alt='Parstagram Updated Walkthrough'><br>

GIF created with [Kap](https://getkap.co).

## Notes

Encountered many glitches / errors with XML files on the profile side.
